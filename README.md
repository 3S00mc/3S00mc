...
<picture>
  ...
  <source media="(prefers-color-scheme: light)" srcset="https://readme-typing-svg.demolab.com?font=Fira+Code&size=15&pause=1000&color=006400&center=true&vCenter=true&multiline=true&width=620&height=70&lines=Attacking+systems+to+defend+them+better.;OWASP+%7C+MITRE+ATT%26CK+%7C+responsible+disclosure." />
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=15&pause=1000&color=00FF41&center=true&vCenter=true&multiline=true&width=620&height=70&lines=Attacking+systems+to+defend+them+better.;OWASP+%7C+MITRE+ATT%26CK+%7C+responsible+disclosure." />
</picture>
...
```
XSS  ·  SQLi  ·  SSRF  ·  IDOR  ·  CSRF  ·  RCE  ·  Auth Bypass  ·  JWT/OAuth Analysis
```
...
![SOC](https://img.shields.io/badge/SOC_Analyst-0078D4?style=for-the-badge&logoColor=white)
![CSIRT](https://img.shields.io/badge/CSIRT-003087?style=for-the-badge&logoColor=white)
![MITRE ATT&CK](https://img.shields.io/badge/MITRE_ATT%26CK-CC0000?style=for-the-badge&logoColor=white)
![SIEM](https://img.shields.io/badge/SIEM-1A1A2E?style=for-the-badge&logoColor=white)
...
![LGPD](https://img.shields.io/badge/LGPD-009C3B?style=for-the-badge&logoColor=white)

```
Log Analysis  ·  IOC Identification  ·  Incident Response  ·  IAM Review  ·  Risk Reporting
```
...
| | Credencial | Emissor | |
|:---:|:---|:---|:---:|
| 🟢 | HL7 FHIR for Healthcare Professionals | M-CareTech | `2026` |
| 🔴 | Cybersecurity Specialist | DIO | `2025` |
| 🔵 | Foundations of Cybersecurity | Google | `2025` |
| ⚪ | IA Arquitetura de Dados | Microsoft | `2025` |
| ⚪ | Hackers do Bem — Cybersecurity | RNP | `ativo` |
...
[![security-experience](https://img.shields.io/badge/📁_security--experience-181717?style=for-the-badge&logo=github&logoColor=00FF41)](https://github.com/3S00mc/security-experience)

</div>

```bash
$ tree ./security-experience
├── /labs          # ambientes controlados · OWASP Top 10 · MITRE ATT&CK
├── /write-ups     # documentação técnica de explorações (em construção)
├── /scripts       # automação de recon e triagem
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/3S00mc/3S00mc/main/assets/footer-dark.svg" />
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/3S00mc/3S00mc/main/assets/footer-light.svg" />
  <img src="https://raw.githubusercontent.com/3S00mc/3S00mc/main/assets/footer-dark.svg" width="100%" alt="footer" />
</picture>
